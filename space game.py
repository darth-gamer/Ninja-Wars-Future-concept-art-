...
line = pygame.image.load("finshline.png")
class Image:
...
class Block:
    def __init__(self, position, size, color):
        ...
        self.color = color
    def draw(self):
        global dirt,grass,lavarock,brimstone,laceration,weakness,tilemap,line
...
tilemap = [
    ...
    '____BBBBBBBBBBB___________________________________________',
    '_______________B__________________________________________',
    '_______________B__________________________________________',
    '__________________________B_______________________________',
    '__________________________B___-___________________________',
    'B_________________________B___-___________________________',
    'BBBBBB____________________B___-___________________________',
    '__________________________B___-___________________________',
    '__________________________B___-___________________________',
    '__________________________BBBBBBBBBBBBBBBBBBBBBB__________',
    '__________________________________________________________',
    '_____________________________----------------_____________',
    '_______B__________-_______________________________________',
    '________BBBBBBBBBB-_______________________________________',
    '_________________B-_______________________________________',
    '_________________B________________________________________',
    '_________________B________________________________________',
    '_________________B________________________________________',
    '_________________B________________________________________',
    '__________________BBBBBBB_________________________________',
    '__________________________________________________________',
    '__________________________________________________________',
    '__________________________________________________________',
    'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB----BBBBBBBBBBBBBBBBBBB',
    '__________________________________________________________',
    '__________________________________________________________',
    'B__B__B-_B_B_B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__',
    '__________________________________________________________',
    '__--__--__________________________________________________',
    '__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B_',
    '__________________________________________________________',
    '__________________________________________________________',
    '_B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__',
    '__________________________________________________________',
    '__________________________________________________________',
    'B__B__B-_B_B_B__B__B__B__B__B__B__B__B__B__B__B__B__B__B__',
    '__________________________________________________________',
    ...
    '__________________________________________________________',
    'BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB----BBBBBBBBBBBBBBBBBBB',
    '__________________________________B____B__________________',
    '__________________________________B____B__________________',
    '__________________________________B____B__________________',
    '__________________________________B____B__________________',
    '__________________________________B____B__________________',
    ...
    '__________________________________________________________',
    '__________________________________________________________',
    '______________________________BBBBBBBBBBBBBB______________',
...
while gameLoop:
    ...
    if gameMode == 1:
        ...
        if setupTimer<30:
            ...
            line = pygame.transform.scale(line,world.size)
